...
public class PerformanceMain {
	...
	public static void main(String[] args) throws Exception {
		...
		Path from = Paths.get("src/com/lec/ex02_buffer/아이폰_01.jpg");
		Path to1 = Paths.get("src/com/lec/ex02_buffer/아이폰_02.jpg");
		Path to2= Paths.get("src/com/lec/ex02_buffer/아이폰_03.jpg");
		...
		System.out.println("DirectBuffer의 소요시간= "+(end-start)+"ns");
